...
object Controller{  
  ...
  def makeAuthorModel(authourId: Any, cleanData: DataFrame) = {
    ...
    (author.train(authorTestTrainSet), author)
  }
...
//       Classifier(arrayModel)
      makeAuthorModel("A1W415JP5WEAJK",mainDataSet)
  }
...
val models = Controller.main

models._2.getMetrics()

val session = Controller.getSession
val msgMkr = MsgMaker()
val msg = msgMkr.msgToVec("This show always is excellent, as far as british crime or mystery.", session)
